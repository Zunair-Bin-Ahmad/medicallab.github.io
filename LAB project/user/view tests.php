                ...
                <div class="row mt-5">
                    <div class="col-md-12">
                      ...
                      <table width="100%">
                          ...
                          <thead>
                            <tr>
                              <th class="col-lg-2" style="background: #0d59a7;color: white;font-size: 20px;">
...
<tr>
                       ...
                       <td class="col-lg-2"><center><?php echo $name; ?></center></td>
                        <td class="col-lg-2"><center><?php echo $price; ?></center></td>
                        
                        <td class="col-lg-2"><center><?php echo $time; ?></center></td>
