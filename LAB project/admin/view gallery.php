            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <tbody >
                      <?php 
                      $query="SELECT *from `add_gallery` WHERE 1";
                      ...
                      <tr>
                        ...
                        <td><center><a href="edit gallery.php?id=<?php  echo $id ?>"><input type="submit" class="btn btn-success btn-sm" value="Edit" name=""></a>
                          <a href="delete gallery.php?id=<?php echo $id ?>"><input type="submit" class="btn btn-danger btn-sm" value="Delete" name=""></a></center></td>
                      </tr>
                      <?php
