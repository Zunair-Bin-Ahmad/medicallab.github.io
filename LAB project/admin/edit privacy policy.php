...
if (isset($_POST['submit'])) {
  ...
  $name=$_POST['name'];
     ...
     $query="UPDATE `privacypolicy` SET `Name`='$name',`Date`='$date',`Time`='$time' WHERE id='$id'";
        ...
        <div class="page-wrapper"> 
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <?php 
                      $query="SELECT * from `privacypolicy` WHERE id=$id";
                      $run=mysqli_query($connect,$query);
                 ...
                 <div class="form-group">
                    <label for="password-1">add privacy statment</label>
