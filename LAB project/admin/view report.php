                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <thead>
                         ...
                         <th><center>PT Name</center></th>
                         <th><center>Lab NO</center></th>
                         <th><center>Reports</center></th>
                      ...
                      <tbody >
                      <?php 
                      $query="SELECT *from `add_report` WHERE 1";
                      ...
                      <tr>
                        ...
                        <td><center><a href="edit report.php?id=<?php  echo $id ?>"><input type="submit" class="btn btn-success btn-sm" value="Edit" name=""></a>
                          <a href="delete reports.php?id=<?php echo $id ?>"><input type="submit" class="btn btn-danger btn-sm" value="Delete" name=""></a></center></td>
                      </tr>
                      <?php
