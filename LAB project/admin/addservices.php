            ...
            <div class="content">
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email-1" class="form-control" type="text" name="catagory">
                  </div>
...
if(isset($_POST['submit']))
{
                  ...
                  $query="INSERT INTO `add_services`(`Name`, `Description`, `Date`, `Time`, `Catagory`, `Type`) VALUES ('$name','$description','$date','$time','$catagory','$type')";
