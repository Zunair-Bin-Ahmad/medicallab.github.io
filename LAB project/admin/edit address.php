...
if (isset($_POST['submit'])) {
  include("connection.php");
     ...
     $query="UPDATE `add_address` SET `Date`='$date',`Time`='$time',`Address`='$address',`Email1`='$email1',`Email2`='$email2',`Phoneno1`='$phoneno1',`Phoneno2`='$phoneno2' WHERE id='$id'";
            ...
            <div class="content">
                ...
                <div class="row">
                 ...
                 <div class="form-group">
                  ...
                  <input type="email" class="form-control" name="email1" value="<?php echo $row['Email1'] ?>">
                  </div>


                  <div class="form-group">
                    <label for="password-1">Email 2</label>
                  <input type="email" class="form-control" name="email2" value="<?php echo $row['Email2'] ?>">
                  </div>

                  <div class="form-group">
                    <label for="password-1">Phone no 1</label>
                  <input type="number" class="form-control" name="phoneno1" value="<?php echo $row['Phoneno1'] ?>">
                  </div>

                  <div class="form-group">
                    <label for="password-1">Phone no 2</label>
                  <input type="number" class="form-control" name="phoneno2" value="<?php echo $row['Phoneno2'] ?>">
                  </div>
