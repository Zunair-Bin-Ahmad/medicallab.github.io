...
if (isset($_POST['submit'])) {
  ...
  $name=$_POST['name'];
     ...
     $query="UPDATE `termsandcondition` SET `Name`='$name',`Date`='$date',`Time`='$time' WHERE id='$id'";
    ...
    if (!$run) {
      ...
      $msg=1;
       header("Location:View terms and condition.php");
    }
        ...
        <div class="page-wrapper"> 
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <?php 
                      $query="SELECT *from `termsandcondition` WHERE id=$id";
                      $run=mysqli_query($connect,$query);
...
<div class="form-group">
                    <label for="password-1">Add terms and conditions</label>
