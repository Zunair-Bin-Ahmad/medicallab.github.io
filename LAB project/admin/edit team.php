...
if (isset($_POST['submit'])) {
  ...
  if ($imagepath=='') {
     $query="UPDATE `add_team` SET `Date`='$date',`Time`='$time',`Name`='$name',`Designation`='$designation',`Image`='$image' WHERE id='$id'";
  ...
  $imagepath="images/".$_FILES['image']['name'];
    ...
    $query="UPDATE `add_team` SET `Date`='$date',`Time`='$time',`Name`='$name',`Designation`='$designation',`Image`='$imagepath' WHERE id='$id'";
    $run=mysqli_query($connect,$query);
    if (!$run) {
      echo "<script>alert('Data Not Inserted')</script>";
    }
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                       ...
                       <?php 
                      $query="SELECT *from `add_team` WHERE id=$id";
                      $run=mysqli_query($connect,$query);
